 ...
 *
 * @author wizarot<wizarot@gamil.com>
 * @github http://github.com/wizarot/WorkerOnSwoole
...
<html>
	...
	<body>
		...
		<?php if(!is_mobile()){?>
			...
			<aside id="info">
			<section id="share">
				       <a rel="external" href="http://github.com/wizarot/WorkerOnSwoole" title="WorkerOnSwoole at GitHub">源代码：<img src="css/images/github.png" alt="fork on github"></a>
				       &nbsp;&nbsp;
			</section>
			<section id="wtf">
			
			    <!-- 尊重他人劳动成果，请保留原作者相关链接 -->
				<h2>在worker man基础上修改的,服务器使用swoole&nbsp; 感谢<a rel="external" href="http://workerman.net/workerman-todpole" target="_blank">workerman</a> &nbsp;&nbsp;感谢 <a href="http://rumpetroll.com/" target="_blank">rumpetroll.com</a></h2>
				<!-- 尊重他人劳动成果，请保留原作者相关链接 -->
